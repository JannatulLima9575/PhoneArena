...
const Navbar = () => {
    ...
    <div className="dropdown">
      ...
      <ul
        ...
        <li><NavLink className={({isActive})=> (isActive? 'text-indigo-600' : '')} to='/cart'>
            <MdShoppingCart size={20} />
        </NavLink></li>
        <li><NavLink className={({isActive})=> (isActive? 'text-indigo-600' : '')} to='/favorites'>
    ...
    <Link  to='/' className="font-bold text-xl">PhoneArena</Link>
    </div>
